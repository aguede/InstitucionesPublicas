...
@XmlType(name = "ChequeDeliveryMethod1Choice", propOrder = { "cd", "prtry" })
@Getter
@Setter
public class ChequeDeliveryMethod1Choice implements Serializable {

    private static final long     serialVersionUID = -1737360174412338759L;

    @XmlElement(name = "Cd")
    private ChequeDelivery1Code cd;
