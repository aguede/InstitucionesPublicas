...
/**
 * Configuration class for swagger instances.
 *
...
@Configuration
@EnableSwagger2
public class ESTGSSPensionsSwaggerConfiguration {
    ...
    public Docket productApi() {
        return new Docket(DocumentationType.SWAGGER_2).select()
                .apis(RequestHandlerSelectors.basePackage("com.ing.pensions.controller")).paths(PathSelectors.any())
                .build().apiInfo(metaData());
    }

    /**
     * Obtains a swagger metadata.
     *
     * @return ApiInfo metadata.
     */
