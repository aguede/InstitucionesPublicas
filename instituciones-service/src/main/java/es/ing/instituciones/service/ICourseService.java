...
public interface ICourseService {
     ...
     * 
     * @param id
     *            - identificador del curso a actualizar
     * @param course
     *            - información actualizada del curso
     * @return curso actualizado
     * @throws EntityNotFoundException
     *             Excepción en caso de no haber encontrado el curso a
     *             actualizar
     */
     ...
     * 
     * @param id
     *            - identificación del curso a eliminar
     * @throws EntityNotFoundException
     *             Excepción en caso de no haber encontrado el curso a eliminar
     */
     ...
     * 
     * @param id
     *            - identificador del curso a buscar
     * @return curso buscado
     * @throws EntityNotFoundException
     *             Excepción en caso de no haber encontrado el curso
     */
